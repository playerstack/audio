 ...
 * React components can be produced by mapping over `UI_ELEMENT_BINDINGS` without
 * bespoke logic (tasks 15.1/15.5).
 *
...
export function createReactElement(binding) {
  ...
  const ReactElement = forwardRef(function ReactElement(props, forwardedRef) {
    ...
    // like `chapters`, `ads`, `spriteData`, `i18n`, ...).
    ...
    useEffect(() => {
      ...
      // needed nor desired.
      // eslint-disable-next-line react-hooks/exhaustive-deps -- subscriptions keyed on element identity; callbacks read from callbacksRef (R5)
    }, []);
