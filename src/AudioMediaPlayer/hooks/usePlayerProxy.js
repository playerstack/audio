      ...
      return {
        onBuffer: function handleBuffer() {
          ...
          updateStateRef.current(function (prev) {
            return Object.assign({}, prev, { isBuffering: true });
          });
        },
              ...
              return Object.assign({}, prev, {
                kernelError: data
                  ? {
                      ...
                      detail: (data.error && data.error.message) || 'Something was wrong with the playback.',
                    }
                  : null,
                isLoading: false,
                playing: false,
        ...
        onPause: function handlePause(e) {
          ...
          updateStateRef.current(function (prev) {
            return Object.assign({}, prev, { playing: false });
          });
        },
        onPlay: function handlePlay(e) {
          if (callbacksRef.current.onPlay) callbacksRef.current.onPlay(e);
          updateStateRef.current(function (prev) {
            return Object.assign({}, prev, { playing: true, isEnded: false, hasAudio: true });
          });
        },
        onPlayBackRateChange: function handleRate(rate) {
          ...
          updateStateRef.current(function (prev) {
            return Object.assign({}, prev, { playbackRate: rate });
          });
        },
        onProgress: function handleProgress(state) {
          ...
          if (!seekingRef.current) {
            updateStateRef.current(function (prev) {
              return Object.assign({}, prev, { played: state.playedSeconds, loaded: state.loaded });
            });
          }
        },
        ...
        onSeek: function handleSeek(time) {
          ...
          updateStateRef.current(function (prev) {
            return Object.assign({}, prev, { seek: time });
          });
        },
